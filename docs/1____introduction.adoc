...
Note, even though Clocks are listed in the 'ModelVariables' element in the modelDescription.xml of the FMU, Clocks will be treated separately then all other variables.
